        </div><? /* header <div class="content"> close */ ?>
                ...
                <ul class="js-subscribe-slider">
                  <li>
                    <div class="reviews-item">
                      <div class="reviews-img" style="background-image: url('/images/reviews.jpg');"></div>
      ...
      <footer class="global-footer">
        ...
        <div class="footer-bottom">
          <div class="wrapper">
            <div class="copyright">
              &copy; 2017  Brand  All Rights Reserved — Олег Фадеев
            </div>
            <div class="soc-serv">
              <a class="fb" href="#"></a>
              <a class="tw" href="#"></a>
  ...
  </section><? /* header <section class="main"> close */ ?>
